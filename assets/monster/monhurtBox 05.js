cc.Class({
    ...
    onLoad () {
        ...
        this.hp = this.monster.getComponent('mon05').hp
        //怪物血量上限  (Get monster MaxHP)
        this.maxhp = this.monster.getComponent('mon05').maxHP
    ...
    onCollisionEnter(other,self){
        ...
        if(this.hp == 0 && this.monster.getComponent('mon05').state != "die"){
            this.sprite.getComponent(cc.Animation).play('mon05_die')
            this.hitback = 500
            this.hpbar.opacity = 0
            this.y = 0
            this.monster.getComponent('mon05').state = "die"
        }
        // console.log(this.hp)
    ...
    update (dt) {
        ...
        if(this.monster.getComponent('mon05').state == "die"){
